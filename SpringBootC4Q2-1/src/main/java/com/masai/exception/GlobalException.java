...
public class GlobalException {
	...
	public ResponseEntity<MyErrorDetail> myExceptionHandler(AccountException ip,WebRequest req){
	...
	public ResponseEntity<MyErrorDetail> myExceptionHandler(InsufficientFundException is,WebRequest req){
		
		MyErrorDetail err =new MyErrorDetail();
		
		err.setTimestamp(LocalDateTime.now());
		err.setMessage(is.getMessage());
		err.setDetails(req.getDescription(false));
