...
public class GlobalProductException {
	...
	public ResponseEntity<MyErrorDetail> myExceptionHandler(LoginException ip,WebRequest req){
	...
	public ResponseEntity<MyErrorDetail> myExceptionHandler(EventException ip,WebRequest req){
