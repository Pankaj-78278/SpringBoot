...
public class GlobalProductException {
	...
	public ResponseEntity<MyErrorDetail> myExceptionHandler(PoliceException ip,WebRequest req){
	...
	public ResponseEntity<MyErrorDetail> myExceptionHandler(PoliceStationException ip,WebRequest req){
	...
	public ResponseEntity<MyErrorDetail> myExceptionHandler(FIRException ip,WebRequest req){
