...
public class Q2 {
//	How Spring-MVC simplifies Java-based Web application development
//	
//	1> A Spring MVC provides an elegant solution to use MVC in spring framework by the help
//	of DispatcherServlet.
//	
//	2> DispatcherServlet is a class that receives the incoming request and maps it to the 
//	right resource such as controllers, models, and views.
//	
