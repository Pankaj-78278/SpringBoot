...
public class GlobalProductException {
	...
	public ResponseEntity<MyErrorDetail> myExceptionHandler(EmployeeException ip,WebRequest req){
	...
	public ResponseEntity<MyErrorDetail> myExceptionHandler(FeedbackException fe,WebRequest req){
